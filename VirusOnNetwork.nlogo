    ...
    [
      ...
      if choice != nobody [
        create-link-with choice [
          set weight random-float virus-spread-chance
;          set weight 100
        ]
...
to spread-virus
  ...
  [
    ...
    [
        let turtle2 (self)
        ask links with [(end1 = turtle1 and end2 = turtle2) or (end1 = turtle2 and end2 = turtle1)]
        [
            let chance (weight)
            ask turtle2 [
              set infected-chance chance
            ]
        ]
        if random-float 100 < infected-chance
            [ become-infected ]
    ]
 ]
end
...
<experiments>
  <experiment name="experiment" repetitions="5" runMetricsEveryStep="true">
    <setup>import-world "/home/pruet/Dev/GraphPartition/greedy_30_0.2_vone_300_6_3.csv"
setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
